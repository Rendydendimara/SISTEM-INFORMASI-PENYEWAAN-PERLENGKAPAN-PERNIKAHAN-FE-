    ...
    <AppBar position="static">
      <Container maxWidth="xl">
        <Toolbar disableGutters>
          ...
          >
            Penyewaan Perlengkapan <br /> Pernikahan Nellysalon <br /> Waingapu
          </Typography>
            ...
            >
              {pages.map((page) => (
                <MenuItem key={page} onClick={handleCloseNavMenu}>
                  <Link style={{ textDecoration: 'unset' }} href={page.link}>
          ...
          >
            Penyewaan PerlengkapanPernikahan NellysalonWaingapu
